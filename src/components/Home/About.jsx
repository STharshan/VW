...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Did a cambelt and service on my daughters car! Great job and great communication! Thank you so much we will be back! I couldn't recommend highly enough!",
    name: "Paul Askew",
  },
